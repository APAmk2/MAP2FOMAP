...
ByteReader& ByteReader::operator>>(uint32_t& i)
{
    uint32_t val;
    _File.read((char*)&val, sizeof(uint32_t));
...
ByteReader& ByteReader::operator>>(uint16_t& i)
{
    uint16_t val;
    _File.read((char*)&val, sizeof(uint16_t));
...
ByteReader& ByteReader::operator>>(uint8_t& i)
{
    uint8_t val;
    _File.read((char*)&val, sizeof(uint8_t));
    i = val;
...
ByteReader& ByteReader::operator>>(int32_t& i)
{
    int32_t val;
    _File.read((char*)&val, sizeof(int32_t));
...
ByteReader& ByteReader::operator>>(int16_t& i)
{
    int16_t val;
    _File.read((char*)&val, sizeof(int16_t));
...
ByteReader& ByteReader::operator>>(int8_t& i)
{
    _File.read((char*)i, sizeof(int8_t));
    return *this;
}
